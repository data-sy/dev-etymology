...
디자인 시스템 상세: spec.md Phase 3-0-1·4-4·4-5, `docs/wireframe/wireframe-v2.html`, `docs/icon/icon_candidate_v2.html`.
...
- 개인정보 처리방침 GitHub Pages 배선 (`site/_config.yml`, front matter)
...
**머지 후 · 출시 전 남은 수동 작업**
- [x] GitHub Pages 발행 — GitHub Actions 워크플로(`.github/workflows/pages.yml`)로 `site/`만 발행 (차단-기본; `docs/`는 비발행). 2026-06-19 완료
...
- [ ] 처리방침의 연락처 이메일(`site/privacy-policy.md`)도 함께 교체
