...
> **참고:** 이 문서의 예시에 나오는 "Agent A/B/C"는 초기의 알파벳 체계다.
> 현재는 역할 기반 5-에이전트 체계(**services / data / ui / settings / ai**)로 재편되었고, 매핑은 [AGENTS.md](./AGENTS.md) 참조.
> 이 문서는 worktree와 멀티 세션의 개념 자체를 설명하기 위한 학습 자료이므로 예시는 원본 그대로 둔다.
